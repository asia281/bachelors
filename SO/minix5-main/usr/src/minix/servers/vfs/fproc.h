...
/* notify vars*/
EXTERN int curr_procs;
EXTERN int listeners_count;      /* Number of event listeners */
EXTERN int failed_listeners_count; /* Number of event listeners that has failed condition */
